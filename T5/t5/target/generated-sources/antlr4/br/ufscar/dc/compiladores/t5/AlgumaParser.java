...
public class AlgumaParser extends Parser {
	...
	public static final int
		...
		RULE_declaracao_local = 3, RULE_declaracao_variavel = 4, RULE_declaracao_constante = 5, 
		RULE_declaracao_tipo = 6, RULE_variavel = 7, RULE_identificador = 8, RULE_dimensao = 9, 
		RULE_tipo = 10, RULE_tipo_basico = 11, RULE_tipo_basico_ident = 12, RULE_tipo_estendido = 13, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"declaracao_variavel", "declaracao_constante", "declaracao_tipo", "variavel", 
			...
			"cmdSenao", "cmdCaso", "cmdPara", "cmdEnquanto", "cmdFaca", "cmdAtribuicao", 
			"cmdChamada", "cmdRetorne", "selecao", "item_selecao", "constantes", 
			"numero_intervalo", "op_unario", "exp_aritmetica", "termo", "fator", 
			"op1", "op2", "op3", "parcela", "parcela_unario", "parentesis_expressao", 
	...
	public static class DeclaracoesContext extends ParserRuleContext {
		public List<Declaracao_local_globalContext> declaracao_local_global() {
			return getRuleContexts(Declaracao_local_globalContext.class);
		}
		public Declaracao_local_globalContext declaracao_local_global(int i) {
			return getRuleContext(Declaracao_local_globalContext.class,i);
		}
	...
	public static class Declaracao_local_globalContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AlgumaListener ) ((AlgumaListener)listener).enterDeclaracao_local_global(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AlgumaListener ) ((AlgumaListener)listener).exitDeclaracao_local_global(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof AlgumaVisitor ) return ((AlgumaVisitor<? extends T>)visitor).visitDeclaracao_local_global(this);
			else return visitor.visitChildren(this);
		}
	}
