...
public interface AlgumaVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link AlgumaParser#declaracao_local_global}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclaracao_local_global(AlgumaParser.Declaracao_local_globalContext ctx);
	/**
