...
public interface AlgumaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link AlgumaParser#declaracao_local_global}.
	 * @param ctx the parse tree
	 */
	void enterDeclaracao_local_global(AlgumaParser.Declaracao_local_globalContext ctx);
	/**
	 * Exit a parse tree produced by {@link AlgumaParser#declaracao_local_global}.
	 * @param ctx the parse tree
	 */
	void exitDeclaracao_local_global(AlgumaParser.Declaracao_local_globalContext ctx);
	/**
