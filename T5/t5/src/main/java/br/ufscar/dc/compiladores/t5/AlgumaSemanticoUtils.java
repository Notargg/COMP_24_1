...
public class AlgumaSemanticoUtils {
    ...
    //Verificar tipo de nome de variável - Modificações para o T4
    ...
    public static TabelaDeSimbolos.TipoAlguma verificarTipo(Escopo escopo, String nomeVar) {
        ...
        for(TabelaDeSimbolos tabela : escopo.getPilhaTabela()) {
            ...
            if(tabela.existe(nomeVar)) {
                ...
                return tabela.verificar(nomeVar);  // Retornar apenas se existir
            }
    ...
    // Adicionar função do T4 para ajustar o retorno e favorecer a troca de tipos - T4
    // Apenas ajustar o retorno da função
